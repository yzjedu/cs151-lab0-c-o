...
print ("1. my partner's name is Cameron")
print ("2. he's from vegas")
print ("3. he lives in Lutherville, Maryland")
print ("4. he has a dog")
print ("5. he is a com sci major")
print ("6. he played an rl1 elden ring run")